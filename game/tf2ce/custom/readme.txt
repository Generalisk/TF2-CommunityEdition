...
For example, you might have the following file structure:
	...
	tf2ce/custom/my_custom_stuff/   <<< This subfolder will be added as a search path
	tf2ce/custom/my_custom_stuff/models/custom_model.mdl
	tf2ce/custom/my_custom_stuff/materials/custom_material.vmt
	tf2ce/custom/my_custom_stuff/materials/vgui/custom_ui_thing.res
	tf2ce/custom/some_mod.vpk       <<< This VPK will be added as a search path
	tf2ce/custom/another_mod.vpk    <<< This VPK will be added as a search path
...
Note that the following directory structure is NOT correct:
	...
	tf2ce/custom/models/my_model.mdl
...
Instead, you would use something like:
	...
	tf2ce/custom/my_custom_stuff/models/my_model.mdl
